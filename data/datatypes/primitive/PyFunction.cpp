...
//
//PyFunction::PyFunction(std::vector<std::string>& code, std::vector<std::string>& vars) : PyObject(Function), code(code), inputVariables(vars) {
//
//}
//
...
//        if (alloc == -1) alloc = mem.alloc(input.at(i));
